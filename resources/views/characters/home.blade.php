    ...
    <div class="container">
        <div class="card mb-2">
            <div class="card-body py-2">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a class="btn btn-sm btn-success" href="{{ url('account/characters/create') }}"><i class="fas fa-plus"></i> Add</a>
                    </div>
                </div>
            </div>
        </div>
        @if( isset($characters) && count($characters) > 0 )
            @foreach($characters as $character)
                <a href="{{ url('account/characters/'.$character->uuid) }}">
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row white rounded d-flex align-items-center flex-row">
                                <div class="col-lg-1 col-md-2 col-sm-3 offset- mb-3 mb-sm-0">
                                    <div class="avatar white text-center px-5 px-sm-0">
                                        <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(9).jpg" class="img-fluid rounded-circle z-depth-1" alt="Class Image"/>
                                    </div>
                                </div>
        ...
        @else
            <div class="col d-flex align-items-center" style="height: 70vh">
                <h3 class="text-muted text-light font-weight-light text-center w-100">Wait! What happened?</h3>
            </div>
        @endif
    </div>
@endsection
